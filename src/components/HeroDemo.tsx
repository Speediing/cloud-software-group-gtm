  ...
  return (
    <>
      <div className="hero-copy">
        <p className="eyebrow">A fleet for Cloud Software Group sellers</p>
        <h1>Keep the work moving between customer conversations.</h1>
        <p className="hero-intro">
          Grok Bot gives each seller a fleet of agents with their own computers.
          They prepare the brief, build the follow-up, and find approved answers
          while the seller stays with the customer.
        </p>
        <div
